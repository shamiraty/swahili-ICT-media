...
<h1 class="mb-0"><i class="fas fa-key me-2"></i> Add New API Key</h1>
            <form action="{{ route('api-keys.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                        ...
                        <option value="web_system" {{ old('category') == 'web_system' ? 'selected' : '' }}>Web System</option>
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i> Save API Key</button>
